...
%[IceConST,IceConVT,IceConKM,IceFloeDis,Skymean] = makePanorama(imageSets,ship_masks,skymask,cameraParams,T_ortho,imageView,T_align,panoView,blending_masks,pixel_loc);
 [IceConST,IceConVT,IceConKM,IceFloeDis,Skymean] = makePanorama_OATRC2015(imageSets,ship_masks,skymask,cameraParams,T_ortho,imageView,T_align,panoView,blending_masks,pixel_loc);
